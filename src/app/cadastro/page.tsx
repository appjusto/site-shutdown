    ...
    <main className="pt-24 lg:pt-48 flex min-h-screen flex-col">
      <div className="max-w-[922px] container flex flex-col gap-10 lg:gap-16 pb-16 lg:pb-24">
        <div className="flex flex-col gap-4">
          ...
          <p>
            Um tema que sempre foi central para o AppJusto e que tem sido pouco
            discutido nos debates que tratam da regulamentação do trabalho por
            plataforma é a <strong>autonomia</strong>.
          </p>
          <p>
            Fora das plataformas, a contratação de um serviço prestado por um
            autônomo – como uma eletricista ou uma faxineira – é negociada entre
            o cliente e o prestador do serviço. Se concordarem com escopo, prazo
            e valor, o serviço é contratado; caso contrário, não há repercussão
            negativa para nenhuma das partes.
          </p>
          <p>
            O surgimento de plataformas para intermediar contratações como essas
            trouxe boas promessas: prestadores seriam encontrados mais
            facilmente e receberiam mais serviços; clientes teriam mais opções e
            mais segurança na execução do serviço.{" "}
          </p>
          <p>
            Com o surgimento do Uber e a popularização da prestação de serviço
            em tempo real, um novo modelo surgiu:{" "}
            <strong>
              agora são os algoritmos que definem o preço do serviço e o repasse
              ao prestador
            </strong>{" "}
          ...
          <p>
            <strong>
              O que justifica que não tenham as mesmas condições das pessoas que
              não trabalham por plataformas?
            </strong>
          </p>
          <p>
          ...
          <ol className="list-decimal ml-16">
            ...
            <li>fornecer informações sobre as contratações para as cidades;</li>
            <li>respeitar os processos de suspensão e bloqueio do cadastro.</li>
          </ol>
          <p>
            Nesse modelo,{" "}
            <strong>
            ...
            <strong>valor mínimo</strong>, e participar de coletivos com outras
            pessoas,{" "}
          ...
          <p>
            ...
            usando equipamentos de segurança. Além de, claro, garantir que todos
            os impostos sejam recolhidos corretamente.
          </p>
          <p>
            ...
            também um enorme <strong>ganho operacional</strong>, tanto por pular
            o processo de cadastro quanto por evitar o trabalho simultâneo e
            desincentivar fraudes.
          </p>
          <p>
            Com a suspensão das operações do AppJusto, ficam a experiência e os
            debates acumulados, que reuniram entregadores, pesquisadores e
