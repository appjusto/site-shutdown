      ...
      <div className="max-w-[922px] container flex flex-col gap-10 lg:gap-16 pb-16 lg:pb-24">
        <div className="flex flex-col gap-4">
          <h1 className="mb-4 lg:mb-6">
            Encerramento das operações do AppJusto
          </h1>
          <p>
          ...
          <p>
            ...
            <strong>
              ...
              <Link href="/cadastro" className="underline" target="_blank">
                neste link
              </Link>
              )
            </strong>
          ...
          <p>
            ...
            . Nosso financiamento coletivo atraiu XXX investidores – um recorde
            em número de participantes de equity crowdfunding no Brasil. O
            código-fonte livre da plataforma foi estudado por alunos/as em
            faculdades do país.
          </p>
          <p>
            Ficamos especialmente orgulhosos das XX mil entregas realizadas, que
            geraram ganhos XX% maiores para entregadores e uma economia de R$ XX
            em taxas para restaurantes, contribuindo com os ODS 8 (trabalho
            digno e crescimento econômico) e 10 (reduzir as desigualdades).
          </p>
          <p>
            ...
            <strong>
              ...
              e na viabilidade do projeto, queremos falar com você
            </strong>
            .
          </p>
          <p>
